/*
Write a program to find the longest increasing subsequence of a list of numbers. 
For example, the longest increasing subsequence of 2,6,3,4,1,2,9,5,8 is 2,3,4,5,8.
*/

package csc320.assingment.pkg2.bonus;

import java.util.*;

public class CSC320Assingment2Bonus {
    public static void main(String[] args) {
        Scanner in = new Scanner(System.in);
        
        //int[] practice = {2,6,3,4,1,2,9,5,8};
